...
a.ptags_input_box){if(a.ptags_noclick)return a.ptags_noclick=!1,e.removeClass("ui-state-hover"),!1;d.val(e.text()).focus().select();a.ptags_remove(e.text())}return!1}));a.ptags_editable&&a.ptags_input_box&&e.hover(function(){b(this).addClass("ui-state-hover")},function(){b(this).removeClass("ui-state-hover")});a.ptags_remover&&e.children().addClass("ui-ptags-tag-text-icon").end().append(b('<a href="#" />').addClass("ui-ptags-tag-remover ui-icon ui-icon-circle-minus").click(function(){a.ptags_remove(e.text());
return!1}));a.ptags_tag_container.append(e)}))};a.ptags_widget.addClass("ui-ptags");a.wrapAll(a.ptags_widget);a.ptags_widget=a.parent();a.ptags_container.addClass("ui-ptags-tag-box-container");a.wrapAll(a.ptags_container);a.ptags_container=a.parent();if(a.ptags_input_box){var d=b(a.get(0)).clone().val("").keydown(function(b){if(b.keyCode==13&&!b.shiftKey)return a.ptags_add(d.val().split(a.ptags_delimiter)),d.val(""),!1}).blur(function(){d.val()!=""&&(a.ptags_add(d.val().split(a.ptags_delimiter)),
d.val(""))});d.attr("id")&&d.attr("id",d.attr("id")+"__ptags");d.attr("name")&&d.attr("name",d.attr("name")+"__ptags");a.ptags_container.append(d)}if(a.ptags_current_text){var f=a.val().split(a.ptags_delimiter);b.merge(a.ptags_tags,f);a.ptags_unique_check();a.ptags_update_val()}if(a.ptags_show_tags)a.ptags_tag_container=b("<span />").addClass("ui-ptags-tag-container"),a.ptags_widget.append(a.ptags_tag_container),a.ptags_update_tags();a.change(a.ptags_sync_input);a.ptags_sortable!=!1&&a.ptags_tag_container.sortable(a.ptags_sortable).bind("sortupdate",
function(){a.ptags_tags=b.map(a.ptags_tag_container.find("a.ui-ptags-tag-text"),function(a){return b(a).text()});a.ptags_update_val()}).bind("sortstop",function(){a.ptags_noclick=!0});a.ptags_show_box||a.css("display","none");this.pines_tags=a});return this};b.fn.ptags.defaults={ptags_tags:[],ptags_current_text:!0,ptags_delimiter:",",ptags_show_tags:!0,ptags_show_box:!1,ptags_input_box:!0,ptags_remover:!0,ptags_editable:!0,ptags_sortable:!1}})(jQuery);
